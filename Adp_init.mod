	...
	if(y==YS-1){
 		...
 		for(i in KR){
	  	...
	  	if(FL[3][0]==1)writeln("Ex.Primal:  ",J8," ,   ",J7," ,   ",J8-J7);
	  		 //if(DAT3.J2-DAT3.J1<1.e-5&&DAT3.J2-DAT3.J1>-1.e-5)FSTOP=1;
...
{samp} Samp={<k,w,y,l,i,S[k][w][i][y][l],D[k][w][i][y][l]>
			|w in WR, y in YR0, l in 0..(LL[k][w][y]-1), i in PR};

{obj} Obj={<k,w,y,l,OBJ1[k][w][y][l],OBJ2[k][w][y][l],1,1>
			|w in WR, y in YR0, l in 0..(LL[k][w][y]-1)};